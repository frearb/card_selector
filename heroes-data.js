...
window.SANGUOSHA_HEROES = [
  ...
  },
  {
    ...
    "skills": [
      ...
      [
        "三陈",
        "觉醒技，结束阶段，若你已有3个“武库”，你增加一点体力上限，回复一点体力，然后获得技能“灭吴※”。灭吴：每回合限一次，你可以移去1个“武库”标记，将一张牌当任意一张非装备牌使用或打出，然后你摸一张牌。"
      ]
    ],
  ...
  },
  {
    ...
    "skills": [
      ...
      [
        "拜印",
        "觉醒技，准备阶段开始时，若\"忍\"标记的数量不小于4，你减1点体力上限，然后获得\"极略\"（你可以弃置1枚“忍”标记，发动下列一项技能：“鬼才”、“放逐”、“集智”、“制衡”或“完杀”。鬼才：当一名角色的判定牌生效前，你可以打出一张牌代替之。放逐：当你受到伤害后，你可以令一名其他角色摸X张牌（X为你已损失的体力值）并翻面。集智：当你使用一张非转化的锦囊牌时，你可以摸一张牌。若此牌为基本牌，你可以弃置此牌，令你本回合的手牌上限+1。制衡：出牌阶段限一次，你可以弃置任意张牌，然后摸等量的牌；若你以此法弃置了所有的手牌，则额外摸一张牌。完杀：你的回合内，当一名角色进入濒死状态时，你令除你和其以外的角色不能对其使用【桃】直到此次濒死结算结束。）。"
      ],
      [
        "连破",
