...
window.SANGUOSHA_HEROES = [
  ...
  },
  {
    ...
    "skills": [
      [
        "咆哮",
        "锁定技，①你使用【杀】无次数限制；②若你装备了武器牌，你使用【杀】无距离限制；③当你于出牌阶段使用【杀】指定目标时，若你本阶段使用过【杀】，你令所有目标角色本回合非锁定技失效、此【杀】不能被响应、此【杀】伤害值+1。此【杀】每未杀死一名目标角色，你失去1点体力并随机弃置一张手牌。"
      ],
      [
        "协击",
        "准备阶段，你可以选择一名其他角色，与其进行一次“协力”。该角色的回合结束时，若你与其“协力”成功，你可以视为对至多三名角色使用一张普通【杀】（此【杀】造成伤害后，你摸等同于此【杀】造成伤害数的牌）。"
      ]
    ],
  ...
  },
  {
    ...
    "source": "https://wiki.biligame.com/msgs/%E8%B0%8B%E5%AD%99%E6%9D%83",
    "skills": [
      [
        "制衡",
        "出牌阶段限一次，你可以弃置任意张牌，然后摸X张牌（X为你以此法弃置的牌数+牌数相等的区域）。"
      ],
      [
        "统业",
        "锁定技，回合结束时，若你每个区域都能于场上找到牌数相同的其他角色的对应区域，你随机获得一张牌（每种牌名限一次）。"
      ],
      [
        "救援",
        "主公技，锁定技。①当其他吴势力角色使用【桃】时，你摸一张牌；②当其他吴势力角色对你使用【桃】时，此牌对你的回复值+1。"
      ]
    ],
  ...
  },
  {
    ...
    "source": "https://wiki.biligame.com/msgs/%E8%B0%8B%E6%9B%B9%E6%93%8D",
    "skills": [
      [
        "奸雄",
        "①游戏开始时，你可以获得至多2个“治世”标记；②当你受到伤害后，你可以获得对你造成伤害的牌并摸1-X张牌（X为“治世”标记数），然后你可以移去1个“治世”标记。"
      ],
      [
        "清正",
        "出牌阶段开始时，你可以弃置手牌中3-X种花色的所有牌（X为“治世”标记数），并观看一名有手牌的其他角色的手牌，弃置其中一种花色的所有牌，若其被弃置的牌数小于你弃置的牌数，你对其造成1点伤害。然后若X小于2且你拥有技能“奸雄”，你可以获得1个“治世”标记。"
      ],
      [
        "护驾",
        "主公技，每轮限一次，当你受到伤害时，你可以将此伤害转移给一名其他魏势力角色。"
      ]
    ],
  ...
  },
  {
    ...
    "source": "https://wiki.biligame.com/msgs/%E6%AD%A6%E5%B0%86%E4%BF%AE%E6%94%B9%E7%9B%B8%E5%85%B3%E8%AE%B0%E5%BD%95%E9%A1%B5%E9%9D%A2%EF%BC%88%E8%B0%8B%E6%94%BB%E7%AF%87%EF%BC%89#%E8%B0%8B%E5%AD%99%E5%B0%9A%E9%A6%99",
    "skills": [
      [
        "结姻",
        "使命技，你的登场势力为“蜀”。①游戏开始时，你选择一名其他角色为结姻角色。②结姻角色死亡后，你减1点体力上限。③结姻角色的出牌阶段开始时，你选择一项：1.令其获得1点护甲；2.你将势力变更为“吴”，然后获得其X张牌（X为游戏轮数且至多为3）。成功：若结姻角色的护甲值为5，则你每轮首次发动“枭姬”后，获得1点护甲。成功：若结姻角色装备区里的牌数为4，则你发动“枭姬”后，本回合使用【杀】的次数+1。失败：若结姻角色死亡或你的势力为“吴”，则你清除结姻角色记录，重铸所有红桃手牌，然后摸两张牌。"
      ],
      [
        "良助",
        "蜀势力技。①当你或结姻角色回复体力后，另一名角色摸一张牌。②出牌阶段结束时，若你已受伤，则你回复1点体力；若你未受伤，则你观看牌堆或弃牌堆中的三张装备牌，然后选择一张交给结姻角色（若其对应装备栏空置，则其使用之）。"
      ],
      [
        "枭姬",
        "吴势力技，当你失去装备区里的一张牌时，你摸两张牌。若你有失败的使命技，则你可以弃置场上的一张牌；若你有成功的使命技，则结姻角色失去装备区里的一张牌时，其摸两张牌。"
      ]
    ],
